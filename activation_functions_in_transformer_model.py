...
train_input_ids, train_attention_masks = tf.data.Dataset.from_tensor_slices(bert_encode(raw_datasets["train"][:1000], MAX_LENGTH)).cache().shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
